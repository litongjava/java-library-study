package com.litongjava.mp4parser.isoparse.utils;
  ...
  public static void cutVideo(String srcVideoPath, String dstVideoPath, double[] times) throws IOException {
    ...
    for (int idst = 0; idst < dstVideoPathes.length; idst++) {
      ...
      for (Track track : tracks) {
        ...
        // movie.addTrack(new AppendTrack(new ClippedTrack(track, startSample1,
        // endSample1), new ClippedTrack(track, startSample2, endSample2)));
